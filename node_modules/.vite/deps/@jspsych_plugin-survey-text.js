...
var SurveyTextPlugin = class {
  ...
  simulate_visual(trial, simulation_options, load_callback) {
    ...
    for (let i = 0; i < answers.length; i++) {
      this.jsPsych.pluginAPI.fillTextInput(display_element.querySelector(`#input-${i}`), answers[i], (data.rt - 1e3) / answers.length * (i + 1));
    }
...
export {
  SurveyTextPlugin as default
};
//# sourceMappingURL=@jspsych_plugin-survey-text.js.map

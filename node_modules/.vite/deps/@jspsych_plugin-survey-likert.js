...
var SurveyLikertPlugin = class {
  ...
  simulate_visual(trial, simulation_options, load_callback) {
    ...
    for (let i = 0; i < answers.length; i++) {
      this.jsPsych.pluginAPI.clickTarget(display_element.querySelector(`input[type="radio"][name="${answers[i][0]}"][value="${answers[i][1]}"]`), (data.rt - 1e3) / answers.length * (i + 1));
    }
...
export {
  SurveyLikertPlugin as default
};
//# sourceMappingURL=@jspsych_plugin-survey-likert.js.map

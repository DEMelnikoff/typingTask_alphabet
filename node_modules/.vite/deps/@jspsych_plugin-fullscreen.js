...
var FullscreenPlugin = class {
  ...
  simulate_visual(trial, simulation_options, load_callback) {
    ...
    if (data.success === false) {
      ...
      load_callback();
      this.jsPsych.pluginAPI.clickTarget(display_element.querySelector("#jspsych-fullscreen-btn"), this.jsPsych.randomization.sampleExGaussian(1e3, 100, 1 / 200, true));
    }
  }
};
FullscreenPlugin.info = info;
export {
  FullscreenPlugin as default
};
//# sourceMappingURL=@jspsych_plugin-fullscreen.js.map

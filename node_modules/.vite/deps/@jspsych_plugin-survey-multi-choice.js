...
// node_modules/@jspsych/plugin-survey-multi-choice/dist/index.js
var info = {
...
var SurveyMultiChoicePlugin = class {
  constructor(jsPsych) {
  ...
  simulate_visual(trial, simulation_options, load_callback) {
    ...
    for (let i = 0; i < answers.length; i++) {
      this.jsPsych.pluginAPI.clickTarget(display_element.querySelector(`#jspsych-survey-multi-choice-response-${i}-${trial.questions[i].options.indexOf(answers[i][1])}`), (data.rt - 1e3) / answers.length * (i + 1));
    }
...
export {
  SurveyMultiChoicePlugin as default
};
//# sourceMappingURL=@jspsych_plugin-survey-multi-choice.js.map

...
// node_modules/@jspsych/plugin-survey-multi-select/dist/index.js
var info = {
...
var SurveyMultiSelectPlugin = class {
  constructor(jsPsych) {
    ...
    display_element.querySelector("#jspsych-survey-multi-select-next").addEventListener("click", () => {
      for (var i2 = 0; i2 < trial.questions.length; i2++) {
        if (trial.questions[i2].required) {
          if (display_element.querySelector("#jspsych-survey-multi-select-" + i2 + " input:checked") == null) {
  ...
  simulate_visual(trial, simulation_options, load_callback) {
    ...
    for (let i = 0; i < answers.length; i++) {
      for (const a of answers[i][1]) {
        this.jsPsych.pluginAPI.clickTarget(display_element.querySelector(`#jspsych-survey-multi-select-response-${i}-${trial.questions[i].options.indexOf(a)}`), (data.rt - 1e3) / answers.length * (i + 1));
      }
    }
...
export {
  SurveyMultiSelectPlugin as default
};
//# sourceMappingURL=@jspsych_plugin-survey-multi-select.js.map

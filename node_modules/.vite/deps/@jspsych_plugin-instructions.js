...
var InstructionsPlugin = class {
  ...
  create_simulation_data(trial, simulation_options) {
    ...
    while (curr_page !== trial.pages.length) {
      const view_time = this.jsPsych.randomization.sampleExGaussian(3e3, 300, 1 / 300);
...
export {
  InstructionsPlugin as default
};
//# sourceMappingURL=@jspsych_plugin-instructions.js.map
